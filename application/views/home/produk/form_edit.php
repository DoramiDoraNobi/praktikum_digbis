                ...
                <div class="contact-form">
                    ...
                    <?php } ?>
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" name="namaProduk" placeholder="Nama Produk" value="<?php echo $produk->namaProduk; ?>"
                                required="required" data-validation-required-message="Mohon isi nama Toko mu" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="file" class="form-control" id="password" name="gambar" placeholder="Gambar Produk" value="<?php echo $produk->foto; ?>"
                                required="required" data-validation-required-message="Please enter your email" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" name="hargaProduk" class="form-control" placeholder="Harga Produk" value="<?php echo $produk->harga; ?>" 
                            required="required" data-validation-required-massage="Masukkan Harga Produk" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" name="jumlahProduk" class="form-control" placeholder="Jumlah Produk" value="<?php echo $produk->stok; ?>"
                            required="required" data-validation-required-massage="Masukkan Jumlah Produk" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" name="beratProduk" class="form-control" placeholder="Berat Produk" value="<?php echo $produk->berat; ?>"
                            required="required" data-validation-required-massage="Masukkan Berat Produk" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea name="deskripsi" id="message" cols="30" rows="3" value="<?php echo $produk->deskripsiProduk; ?>"
