                ...
                <form action="<?php echo site_url('toko/update'); ?>" method="post" enctype="multipart/form-data">
                    <div class="control-group">
                        <input type="text" class="form-control" id="name" name="namaToko" placeholder="Nama Toko"
                            required="required" data-validation-required-message="Mohon isi nama Toko mu" value="<?php echo $toko->namaToko; ?>" />
                    ...
                    <div class="control-group">
                        ...
                        required="required" data-validation-required-message="Masukkan Deskripsi Toko"><?php echo $toko->deskripsi; ?></textarea>
                    </div>
